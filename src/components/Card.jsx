...
const completedIcon = '/icons/status/Done.svg';
    ...
    <div className='card'>
      ...
      <div className='card-body'>
        {grouping === 'status' ? null : (
          <img
            src={'/icons/status/' + ticket.status + '.svg'}
            ...
            <img
              src={
                ticket.priority === 4
                  ...
                  : '/icons/priority/' + ticket.priority + '.svg'
              }
              alt={`Priority: ${
                ticket.priority === 4 ? 'High Priority' : ticket.priority
              }`}
            />
          </div>
        )}
